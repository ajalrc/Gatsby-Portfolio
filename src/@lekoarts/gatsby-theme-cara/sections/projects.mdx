...
Using Object Oriented Programming, I created a simple Text-based Black Jack game which uses several classes for players, decks and cards. The rules are still the same as in the actual game.
</ProjectCard>
